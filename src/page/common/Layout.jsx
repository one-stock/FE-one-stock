...
function Layout() {
    return (
        <div className='w-full min-h-dvh bg-main-color flex justify-center'>
            <div className="w-full bg-main flex flex-col min-h-dvh">
                ...
                <main className="flex pt-16 pb-20 max-w-120 w-full bg-main">
                    <Outlet/>                
                </main>
